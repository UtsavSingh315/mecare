          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                By accessing and using MeCare, you accept and agree to be bound
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Permission is granted to temporarily download one copy of MeCare
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                MeCare is for informational purposes only and is not intended as
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                contact us at support@mecare.app
              </p>
            </section>
          </div>
        </div>
